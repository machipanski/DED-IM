...
class ThinWallRegions:
    ...
    def make_thin_walls(self, layer_name, island_name, island_img: np.ndarray, base_frame, path_radius, mask, folders: Paths):
        ...
        #             # break
        #             region =  ThinWall(99,[],[],[],0,[],[],[],)
        #     else:
        #         region =  ThinWall(99,[],[],[],0,[],[],[],)
        #     return region
        
        sem_galhos, sem_galhos_dist, trunks = sk.create_prune_divide_skel(
            island_img.astype(np.uint8), path_radius# TODO:Achar o melhor size para o serviço
        )
        # self.medial_transform = sem_galhos * sem_galhos_dist
        self.medial_transform = (f"L{layer_name:03d}_I{island_name:03d}_mat.png")
